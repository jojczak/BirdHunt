...
class AboutStage: ScreenWithUIStage.ScreenStage() {
    private val aboutTable = Table().also { aT ->
        ...
        aT.add(Image(AssetsLoader.get<Texture>(Asset.UI_S_PEN))).padTop(PR_PAD / 2).row()
        aT.add(getParagraph("about_p4")).fillX().expandX().padTop(PR_PAD / 2).row()
        aT.add(getParagraph("about_p5")).fillX().expandX().padTop(PR_PAD).row()
        aT.add(getParagraph("about_p6", true)).fillX().expandX().padTop(PR_PAD / 2).row()
        aT.add(getParagraph("about_p7")).fillX().expandX().padTop(PR_PAD / 2).row()
        ...
        aT.add(getParagraph("about_p10b", true)).fillX().expandX().padTop(PR_PAD / 2).row()
        aT.add(getParagraph("about_p11")).fillX().expandX().padTop(PR_PAD).row()
        aT.add(getParagraph("about_p11b", true)).fillX().expandX().padTop(PR_PAD / 2).row()
        aT.add(getParagraph("about_p12")).fillX().expandX().padTop(PR_PAD).row()
        aT.add(getParagraph("about_p13")).fillX().expandX().padTop(PR_PAD).row()
    }
